function MoreHelpRow({ title, description, onClick, Icon }) {
    return (<div className="hover:bg-lightgray/30 flex cursor-pointer items-center justify-between gap-2 rounded px-4 py-2" onClick={onClick}>
...
//# sourceMappingURL=MoreHelpRow.js.map