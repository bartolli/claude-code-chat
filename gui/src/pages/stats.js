...
function Stats() {
    ...
    return (<div style={{
      ...
      <div onClick={() => navigate(-1)} className="sticky top-0 m-0 flex cursor-pointer items-center p-0" style={{
      ...
      <div className="p-2">
        <div className="flex items-center gap-2">
          ...
          <CopyIconButton text={generateTable([["Day", "Generated Tokens", "Prompt Tokens"]].concat(days.map((day) => [
            day.day,
            day.generatedTokens,
            day.promptTokens,
        ])))}/>
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            {days.map((day) => (<Tr key={day.day} className="">
                <Td>{day.day}</Td>
        ...
        <div className="flex items-center gap-2">
          ...
          <CopyIconButton text={generateTable([["Model", "Generated Tokens", "Prompt Tokens"]].concat(models.map((model) => [
            model.model,
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            {models.map((model) => (<Tr key={model.model} className="">
                <Td>{model.model}</Td>
