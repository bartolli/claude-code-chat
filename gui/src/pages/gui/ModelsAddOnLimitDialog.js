...
export function ModelsAddOnLimitDialog() {
    ...
    return (<div className={`flex flex-col gap-1 px-3 pb-2 pt-3`}>
      ...
      <div className="mt-2 flex flex-col gap-1.5">
        ...
        <div className="flex flex-row flex-wrap items-center gap-2">
          <SecondaryButton className="flex flex-row items-center gap-2 hover:opacity-70" onClick={() => {
...
//# sourceMappingURL=ModelsAddOnLimitDialog.js.map