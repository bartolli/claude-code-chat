...
describe("Chat page test", () => {
    ...
    it.skip("should send a message and receive a response", async () => {
        ...
        const inputBox = await waitFor(() => container.querySelector(".ProseMirror").querySelector("p"));
    ...
    it("should show apply cancellation", async () => {
        ...
        await waitFor(() => {
            const cancelApplyButton = screen.queryByTestId("notch-applying-cancel-button");
