...
export function ToolCallStatusMessage({ tool, toolCallState, }) {
    ...
    return (<div className="text-description line-clamp-4 min-w-0 break-words" style={{ fontSize }} data-testid="tool-call-title">
      {`Continue ${intro} ${message}`}
    </div>);
}
//# sourceMappingURL=ToolCallStatusMessage.js.map