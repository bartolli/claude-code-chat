...
const openSourceModels = Object.values(models).filter(({ isOpenSource }) => isOpenSource);
export const apiBaseInput = {
    inputType: "text",
    key: "apiBase",
    label: "API Base",
...
export const providers = {
    openai: {
        ...
        longDescription: "Use gpt-4, gpt-3.5-turbo, or any other OpenAI model. See [here](https://openai.com/product#made-for-developers) to obtain an API key.",
        icon: "openai.png",
    ...
    anthropic: {
        ...
        description: "Anthropic builds state-of-the-art models with large context length and high recall",
        icon: "anthropic.png",
        tags: [ModelProviderTags.RequiresApiKey],
        longDescription: "To get started with Anthropic models, you first need to sign up for the open beta [here](https://claude.ai/login) to obtain an API key.",
        collectInputFor: [
            {
                inputType: "text",
                key: "apiKey",
    ...
    "function-network": {
        ...
        description: "Run open-source models on Function Network. Private, Affordable User-Owned AI",
    ...
    ovhcloud: {
        ...
        provider: "ovhcloud",
        refPage: "ovhcloud",
        description: "OVHcloud AI Endpoints is a serverless inference API that provides access to a curated selection of models (e.g., Llama, Mistral, Qwen, Deepseek). It is designed with security and data privacy in mind and is compliant with GDPR.",
...
Select the \`GPT-4o\` model below to complete your provider configuration, but note that this will not affect the specific model you need to select when creating your Azure deployment.`,
        ...
        tags: [ModelProviderTags.RequiresApiKey],
        refPage: "azure",
        apiKeyUrl: "https://azure.microsoft.com/en-us/products/ai-services/openai-service",
    ...
    mistral: {
        title: "Mistral",
        provider: "mistral",
        description: "The Mistral API provides seamless access to their models, including Codestral, Mistral 8x22B, Mistral Large, and more.",
        icon: "mistral.png",
    ...
    cohere: {
        ...
        provider: "cohere",
        refPage: "cohere",
        description: "Optimized for enterprise generative AI, search and discovery, and advanced retrieval.",
        icon: "cohere.png",
        tags: [ModelProviderTags.RequiresApiKey],
        longDescription: "To use Cohere, visit the [Cohere dashboard](https://dashboard.cohere.com/api-keys) to create an API key.",
        collectInputFor: [
            {
                inputType: "text",
                key: "apiKey",
    ...
    groq: {
        ...
        provider: "groq",
        icon: "groq.png",
        description: "Groq is the fastest LLM provider by a wide margin, using 'LPUs' to serve open-source models at blazing speed.",
        longDescription: "To get started with Groq, obtain an API key from their website [here](https://wow.groq.com/).",
        tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
        collectInputFor: [
            {
                inputType: "text",
    ...
    deepseek: {
        ...
        provider: "deepseek",
        icon: "deepseek.png",
        description: "DeepSeek provides cheap inference of its DeepSeek Coder v2 and other impressive open-source models.",
        longDescription: "To get started with DeepSeek, obtain an API key from their website [here](https://platform.deepseek.com/api_keys).",
        tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
        collectInputFor: [
            {
                inputType: "text",
    ...
    together: {
        ...
        provider: "together",
        refPage: "together",
        description: "Use the TogetherAI API for extremely fast streaming of open-source models",
        icon: "together.png",
    ...
    ncompass: {
        ...
        provider: "ncompass",
        refPage: "ncompass",
        description: "Use the nCompass API for extremely fast streaming of open-source models",
        icon: "ncompass.png",
    ...
    novita: {
        ...
        provider: "novita",
        refPage: "novita",
        description: "Use Novita AI API for extremely fast streaming of open-source models",
        icon: "novita.png",
    ...
    gemini: {
        ...
        provider: "gemini",
        refPage: "geminiapi",
        description: "Try out Google's state-of-the-art Gemini model from their API.",
    ...
    llamafile: {
        ...
        provider: "llamafile",
        icon: "llamafile.png",
        description: "llamafiles are a self-contained binary to run an open-source LLM",
        ...
        collectInputFor: [...completionParamsInputsConfigs],
        downloadUrl: "https://github.com/Mozilla-Ocho/llamafile?tab=readme-ov-file#quickstart",
    },
    replicate: {
        title: "Replicate",
        provider: "replicate",
...
After it's up and running, you can start using Continue.`,
    ...
    "openai-aiohttp": {
        ...
        provider: "openai",
        description: "If you are using any other OpenAI-compatible API, for example text-gen-webui, FastChat, LocalAI, or llama-cpp-python, you can simply enter your server URL",
...
- [FastChat](https://github.com/lm-sys/FastChat/blob/main/docs/openai_api.md)`,
    ...
    watsonx: {
        ...
        provider: "watsonx",
        refPage: "watsonX",
        description: "Explore foundation models from IBM and other third-parties depending on your use case.",
...
To get started, [register](https://dataplatform.cloud.ibm.com/registration/stepone?context=wx) on watsonx SaaS, create your first project and setup an [API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key).`,
    ...
    cerebras: {
        ...
        provider: "cerebras",
        icon: "cerebras.png",
        description: "Cerebras Inference is a custom silicon for fast inference of LLM models.",
    ...
    vertexai: {
        ...
        longDescription: "Use the supported Vertex AI models - see [here](https://cloud.google.com/docs/authentication/provide-credentials-adc) to authenticate",
        icon: "vertexai.png",
        packages: [
    ...
    askSage: {
        ...
        provider: "askSage",
        icon: "ask-sage.png",
        description: "The Ask Sage API provides seamless access to LLMs including OpenAI, Anthropic, Meta, Mistral, and more.",
    ...
    siliconflow: {
        ...
        longDescription: "To get started with SiliconFlow, obtain an API key from their website [here](https://cloud.siliconflow.cn/account/ak).",
        tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
        collectInputFor: [
            {
                inputType: "text",
