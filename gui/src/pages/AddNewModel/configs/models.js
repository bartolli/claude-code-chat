export const models = {
    ...
    mistralChat: {
        title: "Mistral Chat",
        description: "A series of open-weight models created by Mistral AI, highly competent for code generation and other tasks",
        params: {
            title: "Mistral",
    ...
    deepseek: {
        ...
        description: "A model pre-trained on 2 trillion tokens including 80+ programming languages and a repo-level corpus.",
        params: {
            title: "DeepSeek-7b",
            model: "deepseek-7b",
            contextLength: 4096,
    ...
    deepseekReasonerApi: {
        ...
        description: "An open-source reasoning model which generates a chain of thought to enhance the accuracy of its responses.",
        params: {
            title: "DeepSeek Reasoner",
    ...
    deepseekCoder2Lite: {
        ...
        description: "DeepSeek-Coder-V2-Lite-Instruct is an open-source code language model that supports 338 programming languages and offers a context length of up to 128,000 tokens.",
        params: {
    ...
    codeLlamaInstruct: {
        ...
        description: "A model from Meta, fine-tuned for code generation and conversation",
        refUrl: "",
        params: {
            title: "CodeLlama-7b",
            model: "codellama-7b",
    ...
    mixtralTrial: {
        ...
        description: "Mixtral 8x7b is a mixture of experts model created by Mistral AI",
        refUrl: "",
        params: {
            title: "Mixtral",
            model: "mistral-8x7b",
    ...
    wizardCoder: {
        title: "WizardCoder",
        description: "A CodeLlama-based code generation model from WizardLM, focused on Python",
        refUrl: "",
        params: {
    ...
    codestral: {
        title: "Codestral",
        description: "Codestral is an advanced generative model created by Mistral AI, tailored for coding tasks like fill-in-the-middle and code completion.",
        params: {
            title: "Codestral",
    ...
    mistral8x22b: {
        title: "Mistral 8x22B",
        description: "A bigger sparse mixture of experts model. As such, it leverages up to 141B parameters but only uses about 39B during inference, leading to better inference throughput at the cost of more vRAM.",
        params: {
            title: "Mistral 8x22B",
    ...
    mistralNemo: {
        title: "Mistral Nemo",
        description: "Mistral Nemo Instruct is a large language model developed by Mistral AI and NVIDIA.",
        params: {
            title: "Mistral Nemo",
            model: "mistral-nemo",
            contextLength: 128_000,
    ...
    gemini20Flash: {
        ...
        description: "Google's powerful workhorse model with low latency and enhanced performance.",
        params: {
            title: "Gemini 2.0 Flash",
    ...
    gemini20FlashLite: {
        ...
        description: "A more efficient version of Gemini 2.0 Flash optimized for faster responses and lower resource usage.",
        params: {
            title: "Gemini 2.0 Flash Lite",
    ...
    gemini20FlashImageGeneration: {
        ...
        description: "A version of Gemini 2.0 Flash optimized for image generation capabilities.",
        params: {
            title: "Gemini 2.0 Flash Image Generation",
    ...
    gemini25ProExp: {
        ...
        description: "Experimental version of Gemini 2.5 Pro with enhanced capabilities and larger output limits.",
        params: {
            title: "Gemini 2.5 Pro Experimental",
    ...
    gemini25Pro: {
        ...
        description: "Google's thinking by default Pro model with up to 64k output context. Best for complex tasks involving reasoning.",
        params: {
            title: "Gemini 2.5 Pro",
    ...
    claude35Sonnet: {
        ...
        description: "Anthropic's most intelligent model, but much less expensive than Claude 3 Opus",
        params: {
    ...
    claude3Opus: {
        title: "Claude 3 Opus",
        description: "The most capable model in the Claude 3 series, beating GPT-4 on many benchmarks",
        params: {
    ...
    claude3Sonnet: {
        ...
        description: "The second most capable model in the Claude 3 series: ideal balance of intelligence and speed",
        params: {
    ...
    claude35Haiku: {
        ...
        description: "The fastest model in the Claude 3.5 series: a compact model for near-instant responsiveness",
        params: {
    ...
    MistralLarge: {
        title: "Mistral Large",
        description: "Mistral Large, the most advanced Large Language Model (LLM) developed by Mistral Al, is an exceptionally powerful model.",
        params: {
    ...
    asksagegpt4gov: {
        title: "GPT-4 gov",
        description: "U.S. Government. Most capable model today - which is similar to GPT-4 but approved for use by the U.S. Government.",
        params: {
            model: "gpt4-gov",
            contextLength: 128_000,
            title: "GPT-4 gov",
            systemMessage: "You are an expert software developer. You give helpful and concise responses.", // Need to set this on the Ask Sage side or just configure it in here to be discussed
        },
    ...
    asksagegpt4ogov: {
        title: "GPT-4o gov",
        description: "U.S. Government. Most capable model today - which is similar to GPT-4o but approved for use by the U.S. Government.",
        params: {
            model: "gpt-4o-gov",
            contextLength: 128_000,
            title: "GPT-4o-gov",
    ...
    asksagegpt4ominigov: {
        ...
        description: "U.S. Government. Latest OpenAI GPT 4o-mini model. More inexpensive than GPT4. Capable of ingesting and analyzing images (JPG, PNG, GIF (20MB files max)). 16,384 token response max.",
        params: {
    ...
    asksagegpt4: {
        title: "GPT-4",
        description: "GPT4 is about 5X more expensive than Ask Sage tokens and 50X more expensive than GPT3.5",
        params: {
            model: "gpt4",
            contextLength: 8_192,
            title: "GPT-4",
    ...
    asksagegpt432: {
        title: "GPT-4-32k",
        description: "The GPT-4-32k model is a variant of the GPT-4 model developed by OpenAI. It is designed to handle a larger context window, capable of processing up to 32,768 tokens, which makes it suitable for scenarios that require extensive information integration and data analysis",
        params: {
            model: "gpt4-32k",
            contextLength: 32_768,
            title: "GPT-4-32k",
    ...
    asksagegpto1: {
        title: "GPT-o1",
        description: "Latest OpenAI GPT-o1 model. More inexpensive than GPT4. Capable of ingesting and analyzing images (JPG, PNG, GIF (20MB files max)).",
        params: {
            model: "gpt-o1",
            contextLength: 128_000,
            title: "GPT-o1",
    ...
    asksagegpto1mini: {
        title: "GPT-o1-mini",
        description: "Latest OpenAI GPT-o1-mini model. More inexpensive than GPT-o1. Capable of ingesting and analyzing images (JPG, PNG, GIF (20MB files max)). 16,384 token response max.",
        params: {
            model: "gpt-o1-mini",
            contextLength: 128_000,
            title: "GPT-o1-mini",
    ...
    asksagegpto3mini: {
        title: "GPT-o3-mini",
        description: "o3-mini can outperform o1 in coding and other reasoning tasks, and is 93% cheaper and has lower latency. It supports function calling, Structured Outputs, streaming, and developer messages. o3-mini comes with a larger context window of 200,000 tokens and a max output of 100,000 tokens",
        params: {
            model: "gpt-o3-mini",
            contextLength: 200_000,
            title: "GPT-o3-mini",
    ...
    Qwen2Coder: {
        ...
        description: "Qwen 2.5 is an auto-regressive language model that uses an optimized transformer architecture.",
        params: {
            title: "Qwen 2.5 Coder 7b",
    ...
    gemma2_2b: {
        title: "Gemma 2 2b IT",
        description: "Gemma 2 IT instruction-tuned language model developed by Google, designed for tasks like question answering, summarization, and reasoning.",
        params: {
            title: "Gemma 2 2b IT",
            model: "gemma2-2b-it",
            contextLength: 4000,
    ...
    phi3mini: {
        ...
        description: "Phi 3 Mini is a 3.8-billion-parameter language model developed by Microsoft.",
        params: {
            title: "Microsoft Phi 3 mini",
            model: "phi-3-mini",
            contextLength: 4000,
    ...
    phi3medium: {
        ...
        description: "Phi 3 Medium is a 14-billion-parameter language model developed by Microsoft.",
        params: {
            title: "Microsoft Phi 3 medium",
            model: "phi-3-medium",
            contextLength: 128_000,
    ...
    olmo7b: {
        title: "OLMo 7b",
        description: "OLMo 7B Instruct HF is a 7-billion-parameter language model by the Allen Institute for AI, fine-tuned for question answering tasks.",
        params: {
            title: "OLMo 7b",
            model: "olmo-7b",
            contextLength: 2000,
    ...
    QwenQwQ_32b_preview: {
        ...
        description: "QwQ-32B-Preview is Qwen's latest experimental research model, focusing on improving AI reasoning capabilities.",
        params: {
            title: "Qwen QwQ 32b Preview",
    ...
    Hunyuan_a52b: {
        title: "Hunyuan A52B",
        description: "Hunyuan-Large is the industry's largest open source Transformer architecture MoE model.",
        params: {
            title: "Hunyuan A52B",
    ...
    Llama31Nemotron_70b: {
        ...
        description: "Llama-3.1-Nemotron-70B-Instruct is a large language model customized by NVIDIA, designed to improve the helpfulness of responses generated by LLM to user queries.",
        params: {
            title: "Llama Nemotron 70B Instruct",
    ...
    qwq32B: {
        title: "QwQ 32B",
        description: "QwQ-32B is Qwen's latest experimental research model, focusing on improving AI reasoning capabilities.",
        params: {
            title: "QwQ 32B",
            model: "QwQ-32B",
            contextLength: 16_000,
