...
export const configSlice = createSlice({
    ...
    initialState,
    reducers: {
        setConfigResult: (state, { payload: result, }) => {
    ...
    selectors: {
        selectSelectedChatModelContextLength: (state) => {
            return (state.config.selectedModelByRole.chat?.contextLength ||
                DEFAULT_MAX_TOKENS);
        },
...
export const { selectSelectedChatModelContextLength, selectUIConfig, selectSelectedChatModel, } = configSlice.selectors;
