...
describe("addToolCallDeltaToState", () => {
    ...
    it("should handle streaming complex JSON arguments", () => {
        ...
        expect(state1.toolCall.function.arguments).toBe('{"path":"src/main.js","changes":{"');
        ...
        expect(state2.toolCall.function.arguments).toBe('{"path":"src/main.js","changes":{"content":"cons');
        ...
        expect(state3.toolCall.function.arguments).toBe('{"path":"src/main.js","changes":{"content":"const message = \\"Hello\\";"}}');
    ...
    it("should handle realistic weather API streaming pattern from OpenAI example", () => {
        ...
        expect(currentState.toolCall.function.arguments).toBe('{"location":"Paris, France');
...
//# sourceMappingURL=toolCallState.test.js.map