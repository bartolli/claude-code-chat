 ...
 * query to the LLM.
 */
export default function useLLMSummary(interaction) {
    return useMemo(() => {
        ...
        let totalTime, toFirstToken, tokensPerSecond, promptTokens, generatedTokens, thinkingTokens;
...
//# sourceMappingURL=useLLMSummary.js.map