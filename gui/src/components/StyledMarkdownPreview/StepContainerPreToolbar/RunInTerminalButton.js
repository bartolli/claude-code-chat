...
export function RunInTerminalButton({ command }) {
    ...
    return (<div className={`text-lightgray flex items-center border-none bg-transparent text-xs text-[${vscForeground}] cursor-pointer outline-none hover:brightness-125`} onClick={runInTerminal}>
      <div className="max-2xs:hidden flex items-center gap-1 transition-colors duration-200 hover:brightness-125" style={{ color: lightGray }}>
        <>
...
//# sourceMappingURL=RunInTerminalButton.js.map