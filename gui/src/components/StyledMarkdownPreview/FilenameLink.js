...
function FilenameLink({ rif }) {
    ...
    try {
        const { relativePathOrBasename } = findUriInDirs(rif.filepath, window.workspacePaths ?? []);
    ...
    return (<>
      <span data-tooltip-id={id} data-tooltip-delay-show={500} className="mx-[0.1em] mb-[0.15em] inline-flex cursor-pointer items-center gap-0.5 rounded-md pr-[0.2em] align-middle hover:ring-1" onClick={onClick}>
...
//# sourceMappingURL=FilenameLink.js.map