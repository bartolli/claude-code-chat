...
function SymbolLink({ symbol, content }) {
    ...
    const id = uuidv4();
    return (<>
      <span className="mx-[0.1em] mb-[0.15em] inline-flex cursor-pointer flex-row items-center gap-[0.2rem] rounded-md align-middle hover:ring-1" onClick={onClick} data-tooltip-id={id} data-tooltip-delay-show={500}>
...
//# sourceMappingURL=SymbolLink.js.map