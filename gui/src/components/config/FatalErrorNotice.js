...
export const FatalErrorIndicator = () => {
    ...
    return (<div className="z-50 cursor-pointer bg-red-600 p-4 text-center text-white" role="alert" onClick={showLumpErrorSection}>
      <strong className="font-bold">Error!</strong>{" "}
      <span className="block sm:inline">Could not load config</span>
      <div className="mt-2 underline">Learn More</div>
    </div>);
};
//# sourceMappingURL=FatalErrorNotice.js.map