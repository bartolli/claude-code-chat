 ...
 */
export function insertCurrentFileContextMention(editor, contextProviders) {
    const foundCurrentFileProvider = contextProviders.find((provider) => provider.title === "currentFile");
...
//# sourceMappingURL=insertCurrentFileContextMention.js.map