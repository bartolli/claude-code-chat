...
export function ExploreBlocksButton(props) {
    ...
    const text = `${isLocal ? "Add" : "Explore"} ${props.blockType === "mcpServers"
        ? "MCP Servers"
    ...
    return (<GhostButton className="w-full cursor-pointer rounded px-2 py-0.5 text-center" style={{
            fontSize: fontSize(-3),
        }} onClick={(e) => {
            e.preventDefault();
            handleClick();
...
//# sourceMappingURL=ExploreBlocksButton.js.map