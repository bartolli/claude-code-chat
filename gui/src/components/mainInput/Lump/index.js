...
import { defaultBorderRadius, vscCommandCenterInactiveBorder, vscInputBackground, } from "../..";
...
export function Lump() {
    ...
    return (<LumpDiv>
      <div className="xs:px-2 px-1 py-0.5">
        ...
        <ContentDiv className="no-scrollbar pr-0.5" hasSection={!!selectedSection} isVisible={isLumpVisible}>
          <SelectedSection />
        </ContentDiv>
      </div>
    </LumpDiv>);
