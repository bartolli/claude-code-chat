...
export function OnboardingCardLanding({ onSelectConfigure, isDialog, }) {
    ...
    return (<div className="xs:px-0 flex w-full max-w-full flex-col items-center justify-center px-4 text-center">
      ...
      {pastFreeTrialLimit ? (<>
          ...
          <Button onClick={openPastFreeTrialOnboarding} className="mt-4 grid w-full grid-flow-col items-center gap-2">
          ...
          <p className="mb-5 mt-0 w-full text-sm">
            ...
            <br />
            <span className="cursor-pointer underline hover:brightness-125" data-tooltip-id="models-addon-tooltip" onClick={() => ideMessenger.post("controlPlane/openUrl", {
                path: "pricing",
            })}>
              Models Add-On
            </span>
          ...
          <Button onClick={onGetStarted} className="mt-4 grid w-full grid-flow-col items-center gap-2">
...
//# sourceMappingURL=OnboardingCardLanding.js.map