...
export function OnboardingModelsAddOnTab() {
    ...
    async function handleUpgrade() {
        try {
            const response = await ideMessenger.request("controlPlane/getModelsAddOnUpgradeUrl", {
    ...
    if (isPolling && isJetbrains) {
        return (<div className="flex h-full w-full flex-col items-center justify-center text-center">
    ...
    return (<div className="flex h-full w-full flex-col items-center justify-center text-center">
      <div className="mb-4 flex flex-col items-center text-center">
        ...
        <span className="text-description text-base">
          Use a{" "}
          <span className="cursor-pointer underline hover:brightness-125" onClick={openPricingPage}>
...
//# sourceMappingURL=OnboardingModelsAddOnTab.js.map