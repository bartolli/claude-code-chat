...
function OllamaModelDownload({ title, modelName, hasDownloaded, }) {
    ...
    return (<div className="flex flex-col">
      ...
      {hasDownloaded ? (<OllamaCompletedStep text={command}/>) : (<>
          <StyledActionButton data-tooltip-id={id} onClick={onClick} className="gap-2">
...
//# sourceMappingURL=OllamaModelDownload.js.map