...
const OSRContextMenu = () => {
    ...
    useEffect(() => {
        ...
        function clickHandler(event) {
            ...
            if (event.button === 2) {
                ...
                setCanCut(!!(isEditable && selectedTextRef.current && isClickWithinSelection));
    ...
    return (<div className="bg-vsc-editor-background absolute flex flex-col gap-1.5 overflow-hidden rounded-md border border-solid border-gray-500 px-3 py-1.5" style={{
            ...position,
            zIndex: 9999,
        }} ref={menuRef}>
      {canCopy && (<div className="cursor-pointer hover:opacity-90" onClick={(e) => {
                onMenuItemClick(e);
                document.execCommand("copy");
            }}>
          Copy
        </div>)}
      {canCut && (<div className="cursor-pointer hover:opacity-90" onClick={(e) => {
                onMenuItemClick(e);
      ...
      <div className="cursor-pointer hover:opacity-90" onClick={(e) => {
            onMenuItemClick(e);
...
//# sourceMappingURL=OSRContextMenu.js.map