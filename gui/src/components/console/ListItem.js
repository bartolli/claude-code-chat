...
export default function ListItem({ interactionId, interaction, onClickInteraction, selected, }) {
    const summary = useLLMSummary(interaction);
    return (<li className={"w-full cursor-pointer pb-[3px] pl-[4px] pr-[4px] pt-[3px] " +
            (selected
                ...
                : "hover:bg-[color:var(--vscode-list-inactiveSelectionBackground)]")} key={interactionId} onClick={() => onClickInteraction(interactionId)}>
