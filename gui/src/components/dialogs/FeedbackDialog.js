...
export default function FeedbackDialog() {
    ...
    return (<div className="p-4 text-center">
      ...
      <form onSubmit={(e) => {
            ...
            dispatch(setDialogMessage(<div className="p-4 text-center">
        ...
        <input style={{ padding: "10px", borderRadius: "5px" }} type="text" name="name" placeholder="Name" required/>
        <input style={{ padding: "10px", borderRadius: "5px" }} type="email" name="email" placeholder="Email" required/>
        <button style={{
            padding: "10px",
            borderRadius: "5px",
            cursor: "pointer",
