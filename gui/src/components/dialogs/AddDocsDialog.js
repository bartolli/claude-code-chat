...
function AddDocsDialog() {
    ...
    const docsIndexingStatuses = useMemo(() => {
        return Object.values(indexingStatuses).filter((status) => status.type === "docs" && status.status === "indexing");
    }, [indexingStatuses]);
    ...
    return (<div className="px-2 pt-4 sm:px-4">
      <div className="">
            ...
            <div className="flex flex-col gap-2">
              <label className="flex w-full flex-col gap-1">
                <div className="flex flex-row items-center gap-1">
                  <span>Title</span>
                  <div>
                    <InformationCircleIcon data-tooltip-id={"add-docs-form-title"} className="text-lightgray h-3.5 w-3.5 select-none"/>
                ...
                <Input type="text" placeholder="Title" value={title} ref={titleRef} onChange={(e) => setTitle(e.target.value)}/>
              </label>
              ...
              <label className="flex w-full flex-col gap-1">
                <div className="flex flex-row items-center gap-1">
                  ...
                  <div>
                    <InformationCircleIcon data-tooltip-id={"add-docs-form-url"} className="text-lightgray h-3.5 w-3.5 select-none"/>
                ...
                <Input ref={urlRef} type="url" placeholder="Start URL" value={startUrl} onChange={(e) => {
            setStartUrl(e.target.value);
        }}/>
              </label>
            </div>
            <div className="flex flex-row justify-end gap-2">
              <SecondaryButton className="min-w-16" disabled={!isFormValid} type="submit">
                Add
              </SecondaryButton>
            </div>
          </form>
...
//# sourceMappingURL=AddDocsDialog.js.map