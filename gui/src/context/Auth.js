...
import { selectCurrentOrg, selectSelectedProfile, setOrganizations, setSelectedOrgId, } from "../redux/slices/profilesSlice";
...
export const AuthProvider = ({ children, }) => {
    ...
    const logout = () => {
        ...
        dispatch(setDialogMessage(<ConfirmationDialog confirmText="Yes, log out" text="Are you sure you want to log out of Continue?" onConfirm={() => {
    ...
    useWebviewListener("sessionUpdate", async (data) => {
