...
suite('Processes Slice Test Suite', () => {
  ...
  suite('Process Management', () => {
    ...
    test('should add multiple processes', () => {
      ...
      state = processesReducer(state, addProcess({
        id: 'process-1',
        pid: 12345,
        sessionId: 'session-1'
      }));
  ...
  suite('Process Updates', () => {
    test('should update process details', () => {
      let state = processesReducer(initialState, addProcess({
        id: 'update-process',
        pid: 11111,
        sessionId: 'session-1'
      }));
      ...
      state = processesReducer(state, updateProcess({
        id: 'update-process',
        updates: {
          pid: 22222
        }
    ...
    test('should not update non-existent process', () => {
      const state = processesReducer(initialState, updateProcess({
        id: 'non-existent',
        updates: {
          pid: 99999
        }
