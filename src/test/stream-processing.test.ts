...
suite('Stream Processing Tests', () => {
    ...
    suite('StreamProcessor', () => {
        ...
        test('should handle multi-chunk messages', async () => {
            ...
            assert.strictEqual(msg.message.content[0].text, 'This is a longer message that might be split across multiple chunks in a real stream.');
    ...
    suite('Real-world Claude Stream Scenarios', () => {
        test('should handle TodoWrite tool usage', async () => {
            ...
            assert.strictEqual(todoMsg.message.content[0].input.todos[0].content, 'Implement login feature');
        ...
        test('should handle thinking content', async () => {
            ...
            assert.strictEqual(thinkingMsg.message.content[0].thinking, 'Let me analyze this problem step by step...');
        });
