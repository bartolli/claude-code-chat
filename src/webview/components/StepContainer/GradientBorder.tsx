...
const GradientBorderWrapper = styled.div<{ isStreaming: boolean; isFocused: boolean; hasLump?: boolean }>`
  padding: 1px;
...
export const GradientBorder: React.FC<GradientBorderProps> = ({ 
  ...
  return (
    <GradientBorderWrapper isStreaming={isStreaming} isFocused={isFocused} hasLump={hasLump}>
      {children}
